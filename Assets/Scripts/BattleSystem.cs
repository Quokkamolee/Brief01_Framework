...
public class BattleSystem : MonoBehaviour
{
    private void Start()
    {
        ...
        Debug.Log("Player One Power Level = " + playerOnePowerLevel
               + " Player Two Power Level = " + playerTwoPowerLevel);
        ...
        Debug.Log("Total Power = " + totalPower + " Player One Chance To Win = "
        + playerOneChanceToWin + " Player Two Chance To Win = " + playerTwoChanceToWin);
        ...
        if (playerOneChanceToWin > playerTwoChanceToWin)
        {
            ...
            Debug.Log(playerOneChanceToWin - playerTwoChanceToWin + "Player One XP Gained = ");
        }
        if (playerTwoChanceToWin > playerOneChanceToWin)
        {
            Debug.Log("Player Two Wins ");
            Debug.Log(playerTwoChanceToWin - playerOneChanceToWin + "Player Two XP Gained = ");
        }
